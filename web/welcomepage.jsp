...
<div class="row welcome-row">
    <div class="content-col">
        <h1 class="welcome-header"><span class="welcome-span">Welcome To </span><span class="airlines-span">BenU Airlines</span><img class="welcome-img-header" src="images/welcomeIcon.png"></h1>
        <p class="welcome-paragraph">We ensure that all of your travel needs are taken care of by simplifying the flight booking process.</p>
